...
// Cadastro das Cartas
// Este código serve para o cadastro de cartas de cidades.
// Siga as instruções para criar cada parte do desafio.
//Teste Jefferson
...
int main() {
    ...
    //exibindo para o usuário as informações da primeira cidade
    ...
    //exibindo para o usuário as informações da segunda cidade
